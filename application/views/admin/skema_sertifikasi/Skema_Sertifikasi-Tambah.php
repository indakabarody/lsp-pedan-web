				...
				<form class="form-horizontal style-form" method="POST" action="" name="form1" id="form1" enctype="multipart/form-data">
					<div class="form-group">
						<div class="form-label-group">
							...
							<input type="text" id="nama" name="nama" class="form-control" placeholder="Masukkan Nama Skema" required="required" autocomplete="off" autofocus="" value="<?= set_value('nama'); ?>">
						</div>
						<div class="form-group">
